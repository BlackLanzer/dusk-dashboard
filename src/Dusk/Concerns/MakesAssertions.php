...
trait MakesAssertions {
    ...
    public function assertSee($text, $ignoreCase = false) {
        ...
        return parent::assertSee($text, $ignoreCase);
    }
    ...
    public function assertSeeIn($selector, $text, $ignoreCase = false) {
        ...
        return parent::assertSeeIn($selector, $text, $ignoreCase);
    }
    ...
    public function selected($field, $value) {
        ...
        return parent::selected($field, $value);
    }

    /** {@inheritdoc} */
    public function assertValue($selector, $value = null) {
        $this->actionCollector->collect(__FUNCTION__, func_get_args(), $this);
